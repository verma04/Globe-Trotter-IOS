...
<ActionBarImage2 navigation={navigation} title={"Explore"} />
    <ScrollView
...
{data1.getCategory.category.sort((a, b) => a.category.localeCompare(b.category)).map(data => 
   <TouchableOpacity key={data.id} onPress={()=> navigation.navigate('SubCategory', { name: data.category  ,sub: data.subCategory }) }  style={[styles.box ,{
...
<View style={styles.text}>
    <Text style={{color:'white', paddingLeft:10, fontSize:18,fontWeight:'700',  fontFamily:"Cushingstd"}} >{data.category}</Text>
</View>
</View>
  ...
  <Shadow>
   ...
   <View style={styles.layer}>     
   <View style={styles.text}>
     <Text  style={{ fontSize:20 , fontFamily: "font"}}>{data.category}</Text>
