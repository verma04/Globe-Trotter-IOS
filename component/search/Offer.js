...
const CalenderEvent = ({route, navigation}) => {
    ...
    const HOMEPAGE_QUERY = `query GetOneMontlySpotlight($offer: String) {
        getSearchMontlySpotlight(offer: $offer) {
          id
          img
          offer
          description
    ...
    <View style={styles.center}>
      ...
      <ImageBackground
               ...
               source={{
                  ...
                  uri: data1.getSearchMontlySpotlight.img}}
               >
               ...
               <Text style={{ fontSize:17,  paddingLeft:10,   fontFamily:"font"}} >{data1.getSearchMontlySpotlight.offer}</Text>
            <Text style={{ paddingLeft:10,   fontFamily:"BasisGrotesque",}} >Date- {moment(data1.getSearchMontlySpotlight.date).format('LL')}</Text>
         ...
         {data1.getSearchMontlySpotlight.description}
           </Text>
          ...
          {data1.getSearchMontlySpotlight.link ? 
(
<Pressable  onPress={()=> navigation.navigate('View', { name:data.getSearchMontlySpotlight.offer, data:{ id: data1.getSearchMontlySpotlight.link} , title:data.getSearchMontlySpotlight.link }) } style={styles.layer  }>     
