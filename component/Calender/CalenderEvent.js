...
const CalenderEvent = ({route, navigation}) => {
  ...
  const HOMEPAGE_QUERY = `query GetCalenderItemsDescription($id: ID) {
    getCalenderItemsDescription(id: $id) {
      description
    }
  }`
console.log(data)
...
<Text style={{fontSize:15, fontFamily:"font"   }} >Event Detials</Text>
<View  style={{marginTop:10  , width:"60%" , flexDirection:"row" , justifyContent:"space-between"  }}>
         {/* <Text>Beginning</Text> 
          <Text>End</Text> */}
          {/* <Text style={{ fontFamily:"BasisGrotesque",}}>Beginning</Text>
          <Text style={{color: "#fea20a"}}>{moment(JSON.parse(data.starTime)).format('h:mm a')}</Text>
          </View>
      <View style={{width:"60%"  , display:"flex" , flexDirection:"row" , justifyContent:"space-between"  }}> */}
        {/* <Text>End</Text>
         <Text>End</Text>  */}
         {/* <Text>End</Text> */}
         {/* <Text style={{color: "#fea20a" ,  fontFamily:"BasisGrotesque",}} >{moment(JSON.parse(data.endTime)).format('h:mm a')}</Text>
         </View>

         <View style={{width:"60%"  , display:"flex" , flexDirection:"row" , justifyContent:"space-between"  }}> */}
        {/* <Text>End</Text>
         <Text>End</Text>  */}
         {/* <Text style={{ fontFamily:"BasisGrotesque",}}>Location</Text>
         <Text style={{color: "#fea20a" ,  fontFamily:"BasisGrotesque",}} >{data.location}</Text>
         </View> */}
...
<HTML source={{ html:data1.getCalenderItemsDescription.description}} 
