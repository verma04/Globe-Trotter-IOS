...
export default function ActionBarImage2({navigation , title }) {
 ...
 return (
    <View style={header}>
      ...
      {title ==="My Account" ?
         (
          <>
         <MaterialIcons name="logout" size={24} color="#FEA20B"  onPress={() =>  signOut()} />
...
<Feather name="edit-2" size={24}color="#FEA20B" onPress={() =>  navigation.navigate("Edit Profile")}/>
