...
const Club = ({ navigation }) => {
 ...
 <View style={styles.center}>
            ...
            <TouchableOpacity   onPress={()=> navigation.navigate('ClubView', {  name:  "Travel Concierge", data:{ img:"https://globe-trotte.fra1.digitaloceanspaces.com/20220404-wzhsx-bulk" , name:  "Travel Concierge",  para:"Experience white glove customer service and recommendations, no matter what corner of the globe." , }  }) }   style={styles.box}>
            <ImageBackground
        style={styles.logo}
        resizeMode="cover"
    ...
    >
      ...
      >
            ...
            <Svg style={{marginBottom:20}} width="67" height="60" viewBox="0 0 67 60" fill="none" xmlns="http://www.w3.org/2000/svg">
<Path d="M19.43 37.3333V16.6667H6.7C3.015 16.6667 0 19.6667 0 23.3333V43.3333C0 47 3.015 50 6.7 50H10.05V60L20.1 50H36.85C40.535 50 43.55 47 43.55 43.3333V37.2667C43.3298 37.3137 43.1052 37.3372 42.88 37.3367H19.43V37.3333ZM60.3 0H30.15C26.465 0 23.45 3 23.45 6.66667V33.3333H46.9L56.95 43.3333V33.3333H60.3C63.985 33.3333 67 30.3367 67 26.6667V6.66667C67 3 63.985 0 60.3 0Z" fill="#FEA20B"/>
</Svg>
    <View  style={styles.bottom} >
            <Text style={{ fontSize:17,   fontFamily:"Cushingstd" , textAlign:"center" , marginBottom:2}} >Travel Concierge</Text>
            <Text style={{ fontFamily:"BasisGrotesque",textAlign:"center"}} >Experience white glove customer service and recommendations, no matter what corner of the globe. </Text>
            ...
            <TouchableOpacity  onPress={()=> navigation.navigate('ClubView', {   name:  "Priority Access", data:{ img:"https://globe-trotte.fra1.digitaloceanspaces.com/20220404-inl1f-bulk" ,name:  "Priority Access",  para:"Receive priority access and invitations or Globe-Trotter events, promotions and new product releases." , }  }) }    style={styles.box}>
            <ImageBackground
        style={styles.logo}
        resizeMode="cover"
    ...
    >
      ...
      >
            ...
            <Svg style={{marginBottom:20}} width="54" height="54" viewBox="0 0 54 54" fill="none" xmlns="http://www.w3.org/2000/svg">
<Path d="M16.0312 0H16.2633C19.6277 0 22.7496 1.78348 24.4582 4.68809L27 9.01336L29.5418 4.68809C31.2504 1.78348 34.3723 0 37.7367 0H37.9688C43.0945 0 47.25 4.15547 47.25 9.28125C47.25 10.8 46.8809 12.1395 46.2375 13.5H50.625C52.4918 13.5 54 15.0082 54 16.875V23.625C54 25.4918 52.4918 27 50.625 27H3.375C1.51137 27 0 25.4918 0 23.625V16.875C0 15.0082 1.51137 13.5 3.375 13.5H7.7625C7.11492 12.1395 6.75 10.8 6.75 9.28125C6.75 4.15547 10.9055 0 16.0312 0ZM20.0918 7.25414C19.2902 5.89676 17.8348 5.0625 16.2633 5.0625H16.0312C13.7004 5.0625 11.8125 6.95145 11.8125 9.28125C11.8125 11.6121 13.7004 13.5 16.0312 13.5H23.7621L20.0918 7.25414ZM37.9688 5.0625H37.7367C36.1652 5.0625 34.7098 5.89676 33.9082 7.25414L30.2379 13.5H37.9688C40.2996 13.5 42.1875 11.6121 42.1875 9.28125C42.1875 6.95145 40.2996 5.0625 37.9688 5.0625ZM3.375 30.375H23.625V54H8.4375C5.64152 54 3.375 51.7324 3.375 48.9375V30.375ZM30.375 54V30.375H50.625V48.9375C50.625 51.7324 48.3574 54 45.5625 54H30.375Z" fill="#FEA20B"/>
</Svg>
   

    <View  style={styles.bottom} >
            <Text style={{ fontSize:17,   fontFamily:"Cushingstd" , textAlign:"center" }} >Priority Access</Text>
            <Text style={{ fontFamily:"BasisGrotesque",textAlign:"center"}} >Receive priority access and invitations or Globe-Trotter events, promotions and new product releases. </Text>
            ...
            <TouchableOpacity  onPress={()=> navigation.navigate('ClubView', {  name:  "Repairs ", data:{ img:"https://globe-trotte.fra1.digitaloceanspaces.com/20220404-4o6w4-bulk",  name:  "Repairs",  para:"As a member, you’ll be eligible to receive free lifetime repairs on all your personal Globe-Trotter luggage." , }  }) }     style={styles.box}>
            <ImageBackground
        style={styles.logo}
        resizeMode="cover"
